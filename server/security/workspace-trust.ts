...
//
// Distinct from sessions/workspace/git/git-trust.ts, which answers "may THIS
// repo's git config run programs during our own read-only git calls?" That
// list is a hand-edited escape hatch for a rare condition and is empty for
// essentially every project; reusing it here would have left Gemini broken
// for everyone.
//
